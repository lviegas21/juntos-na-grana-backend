...
export class FamilyComponent implements OnInit {
  ...
  trackId = (item: IFamily): number => this.familyService.getFamilyIdentifier(item);
      ...
      .pipe(
        ...
        tap(() => {
          if (this.families().length === 0) {
            ...
            this.families.set(this.refineData(this.families()));
          }
        }),
      )
      .subscribe();
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.families.set(this.refineData(dataFromBody));
  }

  protected refineData(data: IFamily[]): IFamily[] {

...
import { sampleWithFullData, sampleWithNewData, sampleWithPartialData, sampleWithRequiredData } from '../wallet.test-samples';

import { RestWallet, WalletService } from './wallet.service';

const requireRestSample: RestWallet = {
